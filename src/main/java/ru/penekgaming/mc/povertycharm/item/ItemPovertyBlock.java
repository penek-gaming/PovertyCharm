...
public class ItemPovertyBlock extends ItemBlock {
    protected final PovertyBlock block;

    public ItemPovertyBlock(PovertyBlock block) {
        this(block, Objects.requireNonNull(block.getRegistryName()));
    }

    public ItemPovertyBlock(PovertyBlock block, @Nonnull ResourceLocation resourceLocation) {
        super(block);
        this.block = block;
